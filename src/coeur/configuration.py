"""
Module de Configuration du Système de Matching Bancaire
========================================================
...
Conforme aux standards bancaires de configuration.
"""
...
class ConfigurationScoring:
    ...
    dans le processus de recrutement bancaire.
    """
...
class GestionnaireConfiguration:
    ...
    def obtenir_resume(self) -> str:
        ...
        return f"""
╔══════════════════════════════════════════════════════════════╗
║         CONFIGURATION SYSTÈME MATCHING BANCAIRE              ║
╚══════════════════════════════════════════════════════════════╝
...
class Configuration:
    ...
    DIPLOMES_RECONNUS = [
        ...
        "deug", "deust", "licence", "licence pro", "master", "mastère", "doctorat",
        # Diplômes français
