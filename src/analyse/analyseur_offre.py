...
class AnalyseurOffre:
    ...
    def _extraire_metadonnees(self, texte: str) -> Dict[str, str]:
        ...
        villes = [
            ...
            'remote', 'télétravail', 'distance', 'yaounde', 'douala', 'maroua', 'mbalmayo', 'bafoussam', 'dschang', 'bafang',
            'banka', 'fotouni', 'fondjomekwet', 'bandja', 'bansoa', 'bangou', 'bangante', 'kekem', 'bandjoun'
        ]
